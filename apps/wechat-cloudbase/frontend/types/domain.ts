...
export interface PracticeRecord extends TodayItem {
  ...
  note?: string
  attachments?: PracticeRecordAttachment[]
  comparisonNotes?: PracticeRecordComparisonNote[]
  reminder?: string
  duration?: number
}
...
export interface PracticeRecordAttachment {
  ...
  duration?: number
  size?: number
  markers?: PracticeRecordAttachmentMarker[]
  createdAt?: unknown
}

export type PracticeRecordMarkerKind = 'good' | 'issue' | 'reminder' | 'neutral'

export interface PracticeRecordAttachmentMarker {
  id: string
  time: number
  kind: PracticeRecordMarkerKind
  note: string
  createdAt?: unknown
}

export interface PracticeRecordComparisonNote {
  id: string
